...
public class noOfNodes {
    public static int countNoOfNodes(BinaryTree<Integer> root){
        if(root==null){
            return 0;
        }
        int count=countNoOfNodes(root.left)+countNoOfNodes(root.right);
        return 1+count;
    }
    ...
    public static void main(String[] args) {
        ...
        PrintTree(root);
        System.out.print(countNoOfNodes(root));
    }    
}
