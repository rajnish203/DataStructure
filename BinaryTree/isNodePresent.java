...
public class isNodePresent {
    public static boolean isPresentWithX(BinaryTree<Integer>root, int target){
        if(root==null){
            return false;
        }
        if(root.data==target){
        ...
        boolean leftAns=isPresentWithX(root.left, target);
        boolean rightAns=isPresentWithX(root.right, target);
    ...
    public static void main(String[] args) {
        ...
        PrintTree(root);
        System.out.print(isPresentWithX(root, 5));
    }    
}
